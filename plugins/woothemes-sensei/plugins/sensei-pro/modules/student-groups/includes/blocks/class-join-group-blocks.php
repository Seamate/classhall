...
class Join_Group_Blocks {
	...
	public function __construct( $group_student_repository ) {
		...
		$this->css_assets = assets_loader( Student_Groups::MODULE_NAME );
	...
	public function enqueue_block_assets() {
		...
		$this->css_assets->register( 'sensei-join-group-block-style', 'style-join-group-block.css' );
		...
		$this->css_assets->register( 'sensei-group-members-list-block-style', 'style-group-members-list-block.css' );
	}
