...
use Sensei_Pro_Student_Groups\Background_Jobs\Group_Course_Student_Access_Start_Welcome_Recurring_Job;
use WP_Post;
...
class Student_Groups {
	...
	public static function init() {
		...
		Group_Course_Student_Access_Start_Welcome_Job::init( $instance->group_course_repository, $instance->group_student_repository, $instance->access_control );
		Group_Course_Student_Access_Start_Welcome_Recurring_Job::init();
	}
	...
	private function load_classes() {
		...
		include_once $this->ssg_dir . '/includes/background-jobs/class-group-course-student-access-start-welcome-job.php';
		include_once $this->ssg_dir . '/includes/background-jobs/class-group-course-student-access-start-welcome-recurring-job.php';
	}
