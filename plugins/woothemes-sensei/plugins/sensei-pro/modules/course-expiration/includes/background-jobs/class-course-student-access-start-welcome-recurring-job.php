<?php
/**
 * File containing the Course_Student_Access_Start_Welcome_Recurring_Job class.
 *
...
/**
 * Class Course_Student_Access_Start_Welcome_Recurring_Job
 *
 * @since 1.24.2
 */
class Course_Student_Access_Start_Welcome_Recurring_Job implements Cron_Job {

	/**
	 * The name of the job.
	 */
	const NAME = 'sensei_pro_student_course_access_start_welcome_recurring';
	...
	public static function on_job_hook( $args ) {
		$job = new Course_Student_Access_Start_Welcome_Job( $args );
	...
	public function get_schedule() {
		/**
		 * Schedule to send welcome email to students when their access to a course starts.
		...
		return apply_filters(
			'sensei_pro_student_access_start_welcome_recurring_job_schedule',
			'0 0 * * *'
		);
	}
}
