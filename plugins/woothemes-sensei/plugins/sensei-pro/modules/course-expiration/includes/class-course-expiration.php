...
use Sensei_Pro_Course_Expiration\Background_Jobs\Course_Student_Access_Start_Welcome_Job;
use Sensei_Pro_Course_Expiration\Background_Jobs\Course_Student_Access_Start_Welcome_Recurring_Job;
...
class Course_Expiration {
	...
	public static function init() {
		...
		if ( version_compare( Sensei()->version, '4.24.3', '>' ) ) {
			add_filter( 'sensei_send_emails', [ $instance, 'prevent_welcome_email_if_course_not_started' ], 10, 6 );
		}
		...
		Course_Student_Access_Start_Welcome_Job::init();
		Course_Student_Access_Start_Welcome_Recurring_Job::init();
	...
	private function include_dependencies() {
		...
		include_once $this->module_dir . '/includes/background-jobs/class-course-student-access-start-welcome-job.php';
		include_once $this->module_dir . '/includes/background-jobs/class-course-student-access-start-welcome-recurring-job.php';
	}
	...
	public function update_learner_start_date( bool $updated, int $post_id, int $comment_id ): bool {
		...
		$input_start_date   = $date->setTime( 0, 0, 0 )->getTimestamp();
	 ...
	 */
	public function prevent_welcome_email_if_course_not_started( $should_send, $user_email, $subject, $message, $identifier, $args ) {
		...
		return ! $this->is_access_expired_or_not_started( $user_id, $args['course:id'] );
	}
}
