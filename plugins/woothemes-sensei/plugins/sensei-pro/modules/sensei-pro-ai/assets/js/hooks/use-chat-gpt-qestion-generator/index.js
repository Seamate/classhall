...
export const useGPTQuestionGenerator = () => {
	...
	useEffect( () => {
		...
		// eslint-disable-next-line react-hooks/exhaustive-deps -- Effect should only run when questionText or questionCount changes. Other dependencies (insertBlock, updateBlockAttributes, createErrorNotice) are stable from useDispatch, and quizBlock is checked for null inside the effect.
