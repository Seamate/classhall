...
const useInitialCoteacherIds = ( courseId ) => {
	const [ initialCoteacherIds, setInitialCoteacherIds ] =
		useState( undefined );
...
export const CoTeachersMetaBox = ( { courseId, courseAuthorId } ) => {
	...
	const excluded = useMemo( () => [ courseAuthorId ], [ courseAuthorId ] );
	...
	}, [ teachers, initialCoteacherIds, selectedCoteachers, isLoading ] );
