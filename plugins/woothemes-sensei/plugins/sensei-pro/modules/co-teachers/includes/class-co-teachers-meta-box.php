...
class Co_Teachers_Meta_Box {
	...
	private function __construct( Co_Teachers $co_teachers ) {
		...
		$this->css_assets  = \Sensei_Pro\Modules\assets_loader( Co_Teachers::MODULE_NAME );
	...
	public function enqueue_frontend_assets() {
		...
		if ( $post && $this->co_teachers->can_current_user_manage_coteachers() ) {
			...
			$this->css_assets->enqueue( 'sensei-co-teachers-meta-box-style', 'style-admin-co-teachers-meta-box.css', [] );
		}
	}
}
