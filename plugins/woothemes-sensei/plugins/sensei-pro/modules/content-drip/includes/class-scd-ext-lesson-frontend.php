...
class Scd_Ext_Lesson_Frontend {
	...
	public function __construct() {
		...
		// Add action to hide lesson actions if the lesson is not accessible.
		add_action( 'sensei_lesson_show_actions', [ $this, 'show_actions_if_not_blocked' ], 10, 2 );
	}

	/**
	 * Chcek if the lesson actions should be shown or not.
	 *
	 * @param bool $should_show Whether the lesson actions should be shown.
	 * @param int  $lesson_id   The lesson ID.
	 *
	 * @since 1.24.2
	 *
	 * @return bool Whether the lesson actions should be shown.
	 */
	public function show_actions_if_not_blocked( $should_show, $lesson_id ) {
